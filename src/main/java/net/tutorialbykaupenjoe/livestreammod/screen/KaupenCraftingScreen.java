...
public class KaupenCraftingScreen extends ContainerScreen<KaupenWorkbenchContainer> implements IRecipeShownListener {
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES
            = new ResourceLocation(LivestreamMod.MOD_ID, "textures/gui/container/kaupen_crafting_table.png");
    ...
    public KaupenCraftingScreen(KaupenWorkbenchContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
